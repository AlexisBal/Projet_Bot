        ...
        while True:
            try:
                ...
                with requests.Session() as session:
                    ...
                    url_div3 = 'https://www.zalando.fr/api/t/js_pixel?flowId=%s&cid=%s&js=true&ga=true' % (
                    ...
                    url_checkout_1 = 'https://www.zalando.fr/api/checkout/address/%s/default' % compte_objet_list[
                        compte].id_adresse
