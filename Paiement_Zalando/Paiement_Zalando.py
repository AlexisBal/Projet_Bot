        ...
        while True:
            try:
                ...
                with requests.Session() as session:
                    ...
                    data_pay_3 = 'CREDIT_CARD&payz_credit_card_former_payment_method_id=-1&payz_credit_card_store_option=opt-in&iframe_funding_source_id=%s' % reponsepaybis["id"]
