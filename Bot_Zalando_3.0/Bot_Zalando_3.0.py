...
class RechercheCommande(Thread):
    def __init__(self, compte_objet_list, carte_objet_list, taille_produit, url_produit, sku, liste_proxys):
    ...
    def ModePaiementAutomatique(self):
            ...
            if reponse == 'o':
                ...
                if len(self.carte_objet_list) == 1:
                    ...
                    if rep_2 == "" \
                        ...
                        return self.carte_objet_list[rep_2]
    ...
    def CheckStock(self):
        while True:
            ...
            requete = requests.get(self.url_produit, headers=headers, verify=False, allow_redirects=False)
            soup = BeautifulSoup(requete.content, "html.parser")
            ...
            while True:
                try:
                    ...
                    with requests.Session() as session:
                        ...
                        # Réglage du proxy
                        session.proxies = {
                            'https': 'https://%s' % self.liste_proxys[x]
                        }
                        ...
                        panier = {"simpleSku": self.sku_produit, "anonymous": False}
